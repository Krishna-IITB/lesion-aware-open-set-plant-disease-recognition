...
numerics but are not experiments. Real-data A–E runs are **not yet evaluated** in this repository
snapshot because data, model access, and GPU execution are external.
